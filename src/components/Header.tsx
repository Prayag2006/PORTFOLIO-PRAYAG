...
export const Header: React.FC = () => {
  return (
    <header className="flex w-full select-none items-center justify-between border-b-2 border-[#171717] px-6 py-4 text-[11px] font-semibold uppercase tracking-[0.2em] text-[#171717] md:px-10 lg:px-14">
